...
public sealed class QuestSchemaRequirements : IAuthoringSchemaRequirementProvider
{
    ...
    [
        ...
        AuthoringSchemaRequirement.Table("character_quests"),
        AuthoringSchemaRequirement.Column("character_quests", "quest_id"),
        AuthoringSchemaRequirement.Column("character_quests", "status"),
        AuthoringSchemaRequirement.Column("character_quests", "current_step_id"),
