...
class D2DialogueSchemaContractTests(unittest.TestCase):
    ...
    def test_mmo_project_checkout_was_not_modified(self) -> None:
        ...
        allowed = {
            ...
            "M prototype/server/features/dialogue/application/DialogueConditionEvaluator.cs",
            ...
            "M prototype/server/features/quests/application/QuestService.cs",
            "M prototype/server/features/quests/persistence/CharacterQuestRepository.cs",
            "M prototype/server/features/progression/application/CharacterProgressionService.cs",
            ...
            "M prototype/tests/MMO.Project.Prototype.Server.Tests/DialogueCatalogExporterConditionTests.cs",
            "M prototype/tests/MMO.Project.Prototype.Server.Tests/DialogueChoiceEffectSettlementPersistenceAcceptanceTests.cs",
            "M prototype/tests/MMO.Project.Prototype.Server.Tests/DialogueChoiceEffectSettlementPathTests.cs",
            "M prototype/tests/MMO.Project.Prototype.Server.Tests/DialogueChoiceEffectSettlementRecoveryWorkerTests.cs",
            "M prototype/tests/MMO.Project.Prototype.Server.Tests/DialogueEffectLifecycleLockContractTests.cs",
            "M prototype/tests/MMO.Project.Prototype.Server.Tests/DialogueConditionEvaluatorTests.cs",
            ...
            "M prototype/tests/MMO.Project.Prototype.Server.Tests/QuestProjectionServiceTests.cs",
