...
public sealed record ItemEquippedVisualDefinition(
    ...
    [property: JsonPropertyName("item_over_grip"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)] IReadOnlyDictionary<string, IReadOnlyDictionary<string, bool>>? ItemOverGripByPose = null);
