...
class T5BNpcSchemaContractsTests(unittest.TestCase):
    ...
    def test_mmo_project_checkout_is_unchanged_except_nested_repo_pointer(self) -> None:
        ...
        allowed_paths = (
            ...
            "prototype/server/features/quests/application/QuestService.cs",
            "prototype/server/features/quests/persistence/",
            "prototype/server/features/progression/",
            ...
            "prototype/tests/MMO.Project.Prototype.Server.Tests/QuestProjectionServiceTests.cs",
