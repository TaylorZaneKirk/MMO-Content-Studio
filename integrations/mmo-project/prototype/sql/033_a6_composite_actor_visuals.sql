-- A6: optional presentation-only composite rig descriptors for NPC and mob definitions.
-- Existing content intentionally remains flat_sprite without conversion.
